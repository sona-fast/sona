						...
						{#each data.characters as char}
							<div class="character-row">
								...
								<div class="char-socials">
									{#if char.twitterUrl}<a href={char.twitterUrl} target="_blank" rel="noopener" aria-label={m.common_social_link({ name: char.name, platform: 'Twitter' })} class="char-social"><TwitterIcon size={14} /></a>{/if}
									{#if char.blueskyUrl}<a href={char.blueskyUrl} target="_blank" rel="noopener" aria-label={m.common_social_link({ name: char.name, platform: 'Bluesky' })} class="char-social"><BlueskyIcon size={14} /></a>{/if}
									{#if char.telegramUrl}<a href={char.telegramUrl} target="_blank" rel="noopener" aria-label={m.common_social_link({ name: char.name, platform: 'Telegram' })} class="char-social"><TelegramIcon size={14} /></a>{/if}
									{#if char.furAffinityUrl}<a href={char.furAffinityUrl} target="_blank" rel="noopener" aria-label={m.common_social_link({ name: char.name, platform: 'FurAffinity' })} class="char-social"><FurAffinityIcon size={14} /></a>{/if}
									{#if char.deviantArtUrl}<a href={char.deviantArtUrl} target="_blank" rel="noopener" aria-label={m.common_social_link({ name: char.name, platform: 'DeviantArt' })} class="char-social"><DeviantArtIcon size={14} /></a>{/if}
									{#if char.patreonUrl}<a href={char.patreonUrl} target="_blank" rel="noopener" aria-label={m.common_social_link({ name: char.name, platform: 'Patreon' })} class="char-social"><PatreonIcon size={14} /></a>{/if}
									{#if char.instagramUrl}<a href={char.instagramUrl} target="_blank" rel="noopener" aria-label={m.common_social_link({ name: char.name, platform: 'Instagram' })} class="char-social"><InstagramIcon size={14} /></a>{/if}
								</div>
							</div>
						{/each}
					</div>
