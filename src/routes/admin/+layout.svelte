<script lang="ts">
	...
	import { Upload, Images, Folder, User, PawPrint, Tags, Settings, LogOut, Sun, Moon, Camera, Smile, CalendarDays } from 'lucide-svelte';
	...
	const sidebarItems = [
		...
		{ href: '/admin/conventions', label: 'Conventions', icon: CalendarDays },
