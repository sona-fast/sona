...
export function defaultPrivacyPolicy(opts: LegalOptions): LegalSection[] {
	...
	return [
		...
		},
		{
			...
			body: [
				"From visitors, we do not require an account and do not require you to provide personal information to browse. The site stores a small preference cookie for your light/dark theme and a browser-local setting for your preferred gallery layout. It sets no advertising or analytics cookies. The only third-party script on the public pages, Cloudflare's Web Analytics beacon described below, is cookieless.",
