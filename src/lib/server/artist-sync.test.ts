...
// ── Backfill identity-verification guard ──────────────────────────────────────
// Thin better-sqlite3 shim over the D1 surface drizzle's d1 driver uses, same
// approach as the cron sync-artists + sticker-import tests.
