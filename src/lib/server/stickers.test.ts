...
// (stickers-design-brief.md): a pack with a managerArtistId is single-artist and
...
function makeDb(): Db {
	...
	sqlite.exec(`
		CREATE TABLE artists (
			...
			deviantart_url TEXT, patreon_url TEXT, instagram_url TEXT, created_at TEXT NOT NULL
		);
